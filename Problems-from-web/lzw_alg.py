def compress_lzv (string_to_compress):
    ...
    return dict_to_decode, compressed_string
...
with open('c:/prog/kjv1.txt', 'r') as f:
    txt = f.read()
...
string_to_compress =  "aaaaaaaaaaaaaaaaabbbabbbbbbbbbbbbbbbbbbbbbbbbbbbbbaaaaaaaaaaaaabcccccccccccc"

compressed_package = compress_lzv(string_to_compress)


print(compressed_package)

decompressed = decompress_lzv(compressed_package[1], compressed_package[0])
