...
# Our function delta will take a sequence of values and a positive integer level, and return a sequence 
# with the 'differences' of the original values. (Differences here means strictly b - a, eg. [1, 3, 2] => [2, -1]) 
